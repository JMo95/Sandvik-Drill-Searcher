...
(3) Once you have your username and password, you need to add them to the top of all files in the API folders.
(4) Name the database 'drills', otherwise the REST api won't function.
(5) Using the mysql database dumb inside of the github called drills-database-dump.txt, recreate the database using that file.
